...
class FormPageOrInGameWaitPage:
    ...
    def _get_next_page_index_if_skipping_apps(self):
        ...
        if current_app != "randomize_apps_otree":
...
class RandomizedAppPage(FormPageOrInGameWaitPage):
    form_model = None
    form_fields = []

    _template_type = 'RandomizedAppPage'
...
class RandomizedAppWaitPage(FormPageOrInGameWaitPage, GenericWaitPageMixin):
    """
    ...
    _template_type = 'RandomizedAppWaitPage'
